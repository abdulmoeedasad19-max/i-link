...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/laptop-rental`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/projector-rental`, changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${base}/laptops/programming`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${base}/laptops/gaming`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${base}/laptops/under-50000`, changeFrequency: "daily", priority: 0.6 },
    { url: `${base}/laptops/under-75000`, changeFrequency: "daily", priority: 0.6 },
    { url: `${base}/laptops/under-100000`, changeFrequency: "daily", priority: 0.6 },
    { url: `${base}/laptops/under-150000`, changeFrequency: "daily", priority: 0.6 },
